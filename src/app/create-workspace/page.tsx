...
const Step1 = () => {
    ...
    return (
        <>
            ...
            <Typography
                text="This will be the name of your Slackzzp workspace - Choose something that your team will recognize!"
